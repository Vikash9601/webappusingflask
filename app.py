...
app.config['MYSQL_PASSWORD'] = 'Vik@sh9601'
...
def register():
    msg = ''
    if request.method == 'POST' and all(field in request.form for field in ['username', 'password', 'email', 'organisation', 'address', 'city', 'state', 'country', 'postalcode']):
        username = request.form['username']
